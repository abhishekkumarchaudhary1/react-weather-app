    ...
    <>
      {weather.name ? (
        <section className='weatherSection w-[80%] max-w-96 my-3 mx-auto'>
          <div className='card bg-white text-2xl flex flex-wrap justify-around items-center my-3 p-2 rounded-md drop-shadow-md'>
            <div className="locationDiv bg-slate-500 w-[100px] h-[100px] flex-col justify-between items-center my-3 mx-auto p-3 rounded-sm">
              ...
              <h1 className='text-white text-center font-bold text-xs rounded-sm'>{weather.name}</h1>
            </div>
            ...
            <div className='conditionDiv border rounded w-[100px] flex-col justify-between items-center my-3 mx-auto p-3'>
              <img className='bg-slate-500 rounded-sm' src={weather.iconURL} alt={weather.condition} />
        ...
        <h2 className='bg-slate-500 text-white w-[80%] max-w-96 my-4 mx-auto p-3 text-center text-sm rounded'>
          {error ? error : 'No City found. Check your search'}
        </h2>
      )}
    </>
  );
